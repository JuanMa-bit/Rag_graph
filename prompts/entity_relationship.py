...
######################
Output:
("entity"{{-}}FED{{-}}ORGANIZATION{{-}}The Fed is the Federal Reserve, which is setting interest rates on Tuesday and Wednesday)
{{-}}
("entity"{{-}}JEROME POWELL{{-}}PERSON{{-}}Jerome Powell is the chair of the Federal Reserve)
{{-}}
("entity"{{-}}FEDERAL OPEN MARKET COMMITTEE{{-}}ORGANIZATION{{-}}The Federal Reserve committee makes key decisions about interest rates and the growth of the United States money supply)
{{-}}
("relationship"{{-}}JEROME POWELL{{->}}FED{{-}}Jerome Powell is the Chair of the Federal Reserve and will answer questions at a press conference{{-}}9)
{{_}}
######################
Text:
...
######################
Output:
("entity"{{-}}ARM{{-}}ORGANIZATION, COMPANY{{-}}Arm is a stock now listed on the Nasdaq which powers 99% of premium smartphones)
{{-}}
("entity"{{-}}SOFTBANK{{-}}ORGANIZATION, COMPANY{{-}}SoftBank is a firm that previously owned Arm)
{{-}}
("relationship"{{-}}ARM{{->}}SOFTBANK{{-}}SoftBank formerly owned Arm from 2016 until present{{-}}5)
{{_}}
######################
-Real Data-
######################
